...
@Slf4j
@SpringBootApplication(scanBasePackages = "com.ippse.web")
@EnableJpaRepositories(basePackages = { "com.ippse.web" })
@EntityScan(basePackages = { "com.ippse.web" })
@ComponentScan(basePackages = { "com.ippse.web" })
@EnableFeignClients
@Configuration
@EnableOAuth2Client
@EnableAutoConfiguration(exclude = { MultipartAutoConfiguration.class })
public class IppseWebApplication {

	public static void main(String[] args) {
		SpringApplication.run(IppseWebApplication.class, args);
	}
